...
# ==========================================================================================
    ...
    with col1:
        subject = st.selectbox("1. SUBJECT (วัตถุเป้าหมาย)", ["Auto (สุ่ม)"] + available_subjects, key="iso_sub")
    ...
    if st.button("🚀 Generate ISOLATED Prompts", use_container_width=True, key="iso_btn"):
        ...
        for i in range(prompt_count_iso):
            sel_subj = random.choice(available_subjects) if subject == "Auto (สุ่ม)" else subject
