...
# ==========================================
# 🧬 1. Master DNA Database (Re-Engineered for Perfect Space & Angles)
# ==========================================
...
DNA_PREMIUM = {
    ...
    "♻️ Eco-Sustainability": {
        "scenes": ["empty premium compressed recycled paper block serving as a sustainable product plinth", "bare raw packed earth pedestal with natural green moss accents"],
    ...
    "🛁 Bathroom Shelf": {
        ...
        "cameras": ["zoomed out lifestyle product photography", "looking slightly down at 45 degree angle"],
...
if app_mode == "🏛️ เครื่องจักรสร้างแท่นวาง (Podiums)":
    ...
    st.markdown("ระบบผลิตงาน Mockup ระดับโฆษณา: **คุมมุมกล้องและพื้นที่ว่าง (Headroom) ให้ลูกค้านำไปใช้วางสินค้าได้จริง**")
    st.markdown("---")
    ...
    if 'prompts' in st.session_state:
        ...
        # --- อัปเดต: เปลี่ยนเป็น \n\n เพื่อเว้น 1 บรรทัดเปล่าระหว่างแต่ละ Prompt (โหมด Podium) ---
...
# ==========================================
    ...
    if 'prompts_isolated' in st.session_state:
        ...
        # --- อัปเดต: เปลี่ยนเป็น \n\n เพื่อเว้น 1 บรรทัดเปล่าระหว่างแต่ละ Prompt (โหมด Isolated) ---
